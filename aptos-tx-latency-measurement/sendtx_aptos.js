...
async function sendTx() {
    ...
    try {
        ...
        {
            sendSlackMsg(`Current balance of <${process.env.SCOPE_URL}/address/${address}|${address}> is less than ${process.env.BALANCE_ALERT_CONDITION_IN_APTOS} APTOS! balance=${balance} APTOS`)
        }
...
async function main() {
    ...
    if(process.env.PRIVATE_KEY === "") {
        ...
        console.log(`Private key is not defined. Create a wallet in https://petra.app/ and paste Mnemonics.`)
